    ...
    <div>
      ...
      <div className='flex justify-between'>
        ...
        <div className='flex'>
          ...
          />
          <button className='rounded-lg border-2 border-sky-500 hover:border-sky-600 bg-sky-500 text-white hover:bg-sky-600 px-2 mx-1 cursor pointer hidden md:block'> search  </button>
        </div>
      </div>
      {/* tables */}
      <div className='flex justify-between mt-8 pb-3 border-b border-blue-500'>
        <div className='md:text-[22px] text-[20px] font-medium md:ml-[1%] ml-4'>
          Cities
        </div>
        <div className='md:text-[22px] text-[20px] font-medium md:-ml-[2%] -ml-4'>
          Country
        </div>
        <div className='md:text-[22px] text-[20px] font-medium md:mr-[5%] mr-4'>
          Timezone
        </div>
      </div>
